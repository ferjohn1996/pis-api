...
namespace PlanningInfoSystemAPI.Migrations
{
    ...
    [Migration("20240319034741_Adding identity token bearer")]
    partial class Addingidentitytokenbearer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlanningInfoSystemAPI.Models.User.UserTbl", b =>
                {
                    ...
                    b.Property<int?>("LastLinkedByUserId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("LastLinkedModifiedDate")
                        .HasColumnType("datetime2");
